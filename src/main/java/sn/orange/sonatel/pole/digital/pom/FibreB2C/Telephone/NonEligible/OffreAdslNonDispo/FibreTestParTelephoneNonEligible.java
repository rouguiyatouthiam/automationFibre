...
public class FibreTestParTelephoneNonEligible {
	...
	public String strBtnCparti="//div[@id='current-message']/div[2]/div[1]/div";
	
	public String strBtnOui="//div[@id='current-message']/div[2]/div[1]/div";
	
	public String strBtnSouscrire ="//div[@class='content-swiper']/div[2]/button/span";
	
	public String strBtnValider ="sub";
	
	
	
	@FindBy(xpath="//div[@id='current-message']/div[2]/div[1]/div")
	...
	public Boolean isBtnCestParti,isBtnOui,isBtnSouscrire,isBtnValider;
		 ...
		 * @param driver
		 */
		public FibreTestParTelephoneNonEligible(BrowserControl bc)
		{
			this.bc = bc;
